    ...
    render() {
        return (
            <div className="container-1">
                <section>
                    <h2 className="noDisplay-1">Main Content</h2>
                    <article>
                        <h1>About Us</h1>
                ...
                <div className="row-1">
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_education_white} alt=""
                                                              className="thumbnail-1"/></p>
                        <h4>EDUCATION</h4>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_water} alt=""
                                                              className="thumbnail-1"/></p>
                        <h4>SAFE WATER</h4>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_food} alt=""
                                                              className="thumbnail-1"/></p>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_health} alt=""
                                                              className="thumbnail-1"/></p>
                        <h4>HEALTHCARE</h4>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_childProtection} alt=""
                                                              className="thumbnail-1"/></p>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={icon_finance} alt=""
                                                              className="thumbnail-1"/></p>
                    ...
                    <div className="columns-1">
                        <p className="thumbnail_align-1"><img src={community_development} alt=""
                                                              className="thumbnail-1"/></p>
